...
# NAM haplotypes after running consensus from DB, methods file maxDiv = 0.001 
...
# Index haplotypes fastqs using minimap
...
# export paths
/workdir/tassel-5-standalone/run_pipeline.pl  -debug \
  -Xmx100g -configParameters config.txt \
  -HaplotypeGraphBuilderPlugin \
