...
# Updated... 2022-05-30
#
# Description: Model 2 (RF with no GO)
# Using pleiotropy scores from number of unique traits
# combined with many responses in a random forest model BUT
# dropping the other populations' pleiotropy scores from the model
# 
...
permuted_merged <- Reduce(function(x, y) merge(x, y, by = c("rr_id", "perm_number", "range_type")), 
                          list(nam_field[,c(1:16,43:44)], 
                               goodman_field[,c(1:2,43:44)], 
                               goodman_mass[,c(1:2,43:44)]))
dim(permuted_merged) # should be: 754900     20
...
# Export
data.table::fwrite(temp, "~/git_projects/pleiotropy/data/model2_RF_prediction_accuracy.csv")
...
# Export to file---------------------------------------------------
ggsave("~/git_projects/pleiotropy/images/model2_random_forest_importance_observed_vs_permuted.png",
...
# Observed data
ggsave("~/git_projects/pleiotropy/images/model2_random_forest_importance_observed.png",
...
# Permuted data
ggsave("~/git_projects/pleiotropy/images/model2_random_forest_importance_permuted.png",
...
# Export to file-----------------------------------------------------------------
ggsave("~/git_projects/pleiotropy/images/model2_random_forest_prediction_accuracy_observed_vs_permuted.png",
